      ...
      <div className="start-screen">
        ...
        <div className="start-inner">
          <header className="start-header">
            <div>
              <p className="eyebrow">{({'aws-summit-sydney-2026':'AWS Summit Sydney 2026','aws-summit-bengaluru-2026':'AWS Summit Bengaluru 2026','aws-summit-mumbai-2026':'AWS Summit Mumbai 2026'})[process.env.REACT_APP_EVENT_CONFIG] || 'AWS Booth Demo'}</p>
