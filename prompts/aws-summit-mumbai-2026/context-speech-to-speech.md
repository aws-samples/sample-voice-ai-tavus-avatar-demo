...
The model is Amazon Nova 2 Sonic, running on Amazon Bedrock. It supports multiple languages including English, French, German, Spanish, Italian, Portuguese, Hindi, Arabic, Korean, Dutch, Polish, Russian, Swedish, and Turkish. It offers multiple voice options including polyglot voices that can speak all supported languages and seamlessly switch between them mid-conversation. It supports function calling natively, so the agent can still take actions like showing content on screen.
